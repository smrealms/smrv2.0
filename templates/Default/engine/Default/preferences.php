	...
	<table>
		...
		<tr>
			...
			<td><div id="friendlyColorSelector">
				...
				<input type="hidden" name="friendly_colour" id="InputFields" value="<?php echo $ThisAccount->getFriendlyColour(); ?>"/></div></td>
		</tr>
		...
		<tr>
			...
			<td><div id="neutralColorSelector">
				...
				<input type="hidden" name="neutral_colour" id="InputFields" value="<?php echo $ThisAccount->getNeutralColour(); ?>"/></div></td>
		</tr>
		...
		<tr>
			...
			<td><div id="enemyColorSelector">
				...
				<input type="hidden" name="enemy_colour" id="InputFields" value="<?php echo $ThisAccount->getEnemyColour(); ?>"/></div></td>
		</tr>
