...
<table class="standardnobord fullwidth">
	...
	<tr>
		<td>
			<img align="left" src="<?php echo $ThisPlanet->getImageThumbLink()?>" width="16" height="16" alt="Planet" title="<?php echo $ThisPlanet->getTypeName(); ?>" /> 
		...
		<td style="width:50%">
			...
			<table class="standard">
				...
				<tr>
					...
					<td align="center"><span id="planetGens"><?php echo $ThisPlanet->getBuilding(PLANET_GENERATOR)['amount']; ?></span></td>
				...
				<tr>
					...
					<td align="center"><span id="planetHangars"><?php echo $ThisPlanet->getBuilding(PLANET_HANGAR)['amount']; ?></span></td>
				...
				<tr>
					...
					<td align="center"><span id="planetHangars"><?php echo $ThisPlanet->getBuilding(PLANET_BUNKER)['amount']; ?></span></td>
				...
				<tr>
					...
					<td align="center"><span id="planetTurrets1"><?php echo $ThisPlanet->getBuilding(PLANET_TURRET)['amount']; ?></span></td>
					<td align="center"><?php echo $ThisPlanet->getMaxBuildings(PLANET_TURRET); ?></td>
				</tr>
				<?php }	?>
			</table>
			<br />
			<?php if ($ThisPlanet->getBuilding(PLANET_GENERATOR)['amount'] 
				+ $ThisPlanet->getBuilding(PLANET_HANGAR)['amount'] 
				+ $ThisPlanet->getBuilding(PLANET_BUNKER)['amount']
				+ $ThisPlanet->getBuilding(PLANET_TURRET)['amount'] > 0) { ?>
			<table class="standard">
				<tr>
				...
				<?php } if ($ThisPlanet->haBuilding(PLANET_BUNKER)) { ?>
				<tr>
				...
				<tr>
					...
					<td align="center"><span id="planetTurrets2"><?php echo $ThisPlanet->getBuilding(PLANET_TURRET)['current']; ?></span> / <?php echo $ThisPlanet->getMaxBuildings(PLANET_TURRET); ?></td>
