...
//					</tr>
					...
					<tr>
						...
						<td width='73%'><input type='text' name='login' size='20' maxlength='32' id='InputFields' value='<?php echo $_REQUEST['login']; ?>'></td>
					</tr>
					<tr>
						<td width='27%'>Password:</td>
						<td width='73%'><input type='password' name='password' size='20' maxlength='32' id='InputFields' value='<?php echo $_REQUEST['password']; ?>'></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td width='73%'><input type='email' name='email' size='50' maxlength='128' id='InputFields' value='<?php echo $_REQUEST['email']; ?>'></td>
					</tr>
					<tr>
